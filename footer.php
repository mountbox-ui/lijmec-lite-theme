    ...
    <footer class="overflow-hidden max-w-[1440px] mx-auto mt-10">
      <div class="-mt-10 sm:-mt-150 mb-4 bg-backgroundBody dark:bg-dark">
        <div class="px-4 md:px-[30px]">
          <div class>
            <h5 class="w-full footer-text-v2 text-center font-satoshi font-medium text-[120px] sm:text-[200px] md:text-[258px] lg:text-[300px] xl:text-[350px] 2xl:text-[386px] uppercase leading-[100%] text-nowrap">LijMec</h5>
          </div>
