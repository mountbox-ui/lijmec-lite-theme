    ...
    <nav class="z-[1000] absolute w-full top-0 left-0 pt-1 sm:pt-5 nav-top" aria-label="Main navigation">
      <div class="flex justify-between py-2 md:py-5 px-5 md:px-10 xl:px-0 max-w-[1440px] mx-auto items-start md:items-center">
        ...
        <div class="flex items-center gap-x-10 hidden lg:flex">
          <ul class="flex items-center gap-x-10 text-white font-medium uppercase">
            <li><a href="<?php echo is_front_page() ? '#about-us' : esc_url(home_url('/#about-us')); ?>" class="nav-link <?php echo is_front_page() ? 'lenis-scroll-to' : ''; ?> hover:text-white transition-colors">About</a></li>
            <li><a href="<?php echo is_front_page() ? '#why-choose-us' : esc_url(home_url('/#why-choose-us')); ?>" class="nav-link <?php echo is_front_page() ? 'lenis-scroll-to' : ''; ?> hover:text-white transition-colors">Why Choose Us</a></li>
            <li><a href="<?php echo is_front_page() ? '#what-we-offer' : esc_url(home_url('/#what-we-offer')); ?>" class="nav-link <?php echo is_front_page() ? 'lenis-scroll-to' : ''; ?> hover:text-white transition-colors">What We Offer</a></li>
          </ul>
      ...
      <div id="mobile-menu" class="fixed inset-0 bg-black z-[1001] hidden flex-col items-center justify-center space-y-8 transition-all duration-300 gap-y-8">
          <ul class="flex flex-col items-center gap-y-8 text-white text-2xl font-medium uppercase">
            <li><a href="<?php echo is_front_page() ? '#about-us' : esc_url(home_url('/#about-us')); ?>" class="mobile-link <?php echo is_front_page() ? 'lenis-scroll-to' : ''; ?> hover:text-gray-300 transition-colors">About</a></li>
            <li><a href="<?php echo is_front_page() ? '#why-choose-us' : esc_url(home_url('/#why-choose-us')); ?>" class="mobile-link <?php echo is_front_page() ? 'lenis-scroll-to' : ''; ?> hover:text-gray-300 transition-colors">Why Choose Us</a></li>
            <li><a href="<?php echo is_front_page() ? '#what-we-offer' : esc_url(home_url('/#what-we-offer')); ?>" class="mobile-link <?php echo is_front_page() ? 'lenis-scroll-to' : ''; ?> hover:text-gray-300 transition-colors">What We Offer</a></li>
          </ul>
